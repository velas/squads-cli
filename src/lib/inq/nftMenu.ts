   ...
   const questions = [
      {
         ...
         name: "validate",
         message:
            "Do you want to validate the metadata accounts before creating the transactions? This may take a while depending on the number of mints",
      },
   ]
   return inquirer.prompt(questions)
}
   ...
   const questions = [
      {
         ...
         name: "ownerValidate",
         message:
            "Do you want to validate the metadata accounts are valid and have their authorities currently set to the vault? (Recommended)",
      },
   ]
   return inquirer.prompt(questions)
}
   ...
   const questions = [
      {
         ...
         name: "safeSign",
         message:
            "Do you want to enforce that the new authority is also a signer? It will require the new authority to be the executor of the multisig transaction. (Recommended)",
      },
   ]
   return inquirer.prompt(questions)
}
   ...
   const questions = [
      {
         ...
         name: "mintList",
         message:
            "Enter the location of the mint list file (.json) for the NFTs you want to transfer out. (Press enter to go back)",
      },
   ]
   return inquirer.prompt(questions)
}
