   ...
   const questions = [
      {
         ...
         message:
            "Enter the public key for the mint (base58) for the ATA, or press Enter to go back:",
      },
      {
         default: v.toBase58(),
         name: "owner",
         ...
         message:
            "Enter the public key (base58) for owner of the ATA - default is your vault/authority:",
      },
   ]
